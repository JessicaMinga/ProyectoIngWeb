    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form class="form-horizontal"  method="post" action="ingresarSitioBase.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
            <textarea type="text" class="form-control" id="descripcion" placeholder="descripcion" name="descripcion"  rows="10" cols="50"></textarea>
          ...
          <label for="inputEmail3" class="col-sm-2 control-label">Provincia</label>
           <div class="col-sm-6">
                            ...
                            <select class="form-control input-lg" id="provincia" name="provincia">
                                ...
                                <?php 
                                    for ($i=0; $i < sizeof($provincias) ; $i++) { 
                                        echo "<option value='$idprovincia[$i]'>".$provincias[$i]."</option>";
                                    }
                                 ?>
              ...
              <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tipo de Sitio</label>
                            ...
                            <select class="form-control input-lg" id="tipo" name="tipo">
                                ...
                                <?php 
                                    for ($i=0; $i < sizeof($tipo) ; $i++) { 
                                        echo "<option value='$idtipositio[$i]'>".$tipo[$i]."</option>";
                                    }
                                 ?>
